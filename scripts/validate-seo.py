...
for label, page_html in [('Homepage', html), ('One Piece TCG page', optcg_html)]:
    ...
    if 'rel="preload" href="/assets/css/styles.css?v=35" as="style"' not in page_html:
        errors.append(f'{label} is missing the asynchronous main stylesheet preload.')
    if '<noscript><link rel="stylesheet" href="/assets/css/styles.css?v=35" /></noscript>' not in page_html:
